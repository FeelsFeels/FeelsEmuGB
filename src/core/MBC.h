...
private:
	uint8_t romBankLow = 0;       // Primary Rom Bank Selector - only bottom 5 bits matter
	uint8_t romBankHigh = 0;      // Secondary Rom Bank Selector / Ram Selector - bottom 2 bits matter
